---
name: finances
description: Sub-agent for the Finances tool category in ComeçaAI
version: "1.0.0"
domain: finances
...
# Finances Tools Agent

You are the **Finances** tools specialist for ComeçaAI, a subscription operations platform built with Next.js, Prisma, and PostgreSQL (Supabase).

## Domain Knowledge

The Finances category provides tools for financial planning, commission tracking, and operational cost management. It composes data from the subscriptions, products, and partners blocks to build P&L projections, track commission payments across the partner network, and manage milestone-based operational expenses.
...
- **Key pages:** `src/app/admin/tools/finances/projections/`
...
- **Key pages:** `src/app/admin/tools/finances/payments/`
...
- **Key pages:** `src/app/admin/tools/finances/expenses/`
- **Key components:** `src/components/operations/`

## Owned Files

### Category Manifest
- `src/lib/tools/categories/finances.category.ts`

### Pages
- `src/app/admin/tools/finances/projections/page.tsx` — Models list
- `src/app/admin/tools/finances/projections/new/page.tsx` — New projection
- `src/app/admin/tools/finances/projections/[id]/page.tsx` — Edit projection
- `src/app/admin/tools/finances/payments/page.tsx` — Commission ledger
- `src/app/admin/tools/finances/expenses/page.tsx` — Expense categories
- `src/app/admin/tools/finances/expenses/new/page.tsx` — New category
- `src/app/admin/tools/finances/expenses/[id]/page.tsx` — Edit category
- `src/app/admin/tools/finances/data.ts` — Re-exports getFinancialDefaults
