...
export async function GET(
  ...
  try {
    ...
    const customer = await svc.getCustomer(parseInt(id));
    return apiSuccess(customer);
  } catch (e) {
    console.error("GET /api/integrations/gorgias/customers/[id] error:", e);
    return apiError("Failed to fetch Gorgias customer", 500);
  }
}
