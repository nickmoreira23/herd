...
/**
 * Knowledge route surface for VIDEO listing.
 *
 * Coexists with src/components/videos/videos-list-client.tsx (Blocks
 ...
 * - videos-list-client.tsx: BlockListPage shell (unified chrome).
 *
