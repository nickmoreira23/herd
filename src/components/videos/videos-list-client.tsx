...
/**
 * Blocks route surface for VIDEO listing.
 *
 * Coexists with src/components/videos/video-table.tsx (or
 ...
 * - video-table.tsx: DataTable + inline chrome + Folders/Breadcrumbs.
 *
