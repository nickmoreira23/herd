...
/**
 * Knowledge route surface for FEED listing.
 *
 * Coexists with src/components/feeds/feeds-list-client.tsx (Blocks
 ...
 * - feeds-list-client.tsx: BlockListPage shell (unified chrome).
 *
