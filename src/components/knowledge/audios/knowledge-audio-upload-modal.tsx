...
interface KnowledgeAudioUploadModalProps {
  open: boolean;
...
export function KnowledgeAudioUploadModal({ open, onOpenChange, onComplete, folderId }: KnowledgeAudioUploadModalProps) {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      const uploadRes = await fetch("/api/knowledge/audios/upload", {
        method: "POST",
        body: formData,
      });
      if (!uploadRes.ok) {
      ...
      const audioRes = await fetch("/api/knowledge/audios", {
        method: "POST",
      ...
      fetch(`/api/knowledge/audios/${audioJson.data.id}/process`, {
        method: "POST",
      }).catch(() => {});
