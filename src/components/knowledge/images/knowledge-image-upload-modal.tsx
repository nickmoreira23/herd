...
interface KnowledgeImageUploadModalProps {
  open: boolean;
...
export function KnowledgeImageUploadModal({ open, onOpenChange, onComplete, folderId }: KnowledgeImageUploadModalProps) {
