...
interface ColumnActions {
  onView: (image: KnowledgeImageRow) => void;
  onDownload: (image: KnowledgeImageRow) => void;
  onToggleActive: (image: KnowledgeImageRow) => void;
  onDelete: (image: KnowledgeImageRow) => void;
  folders?: KnowledgeFolderRow[];
  onMoveToFolder?: (image: KnowledgeImageRow, folderId: string | null) => void;
}
...
export function getKnowledgeImageColumns(actions: ColumnActions): ColumnDef<KnowledgeImageRow>[] {
  return [
    {
      accessorKey: "name",
      header: ({ column }) => (
