...
interface ColumnActions {
  onView: (video: KnowledgeVideoRow) => void;
  onDownload: (video: KnowledgeVideoRow) => void;
  onToggleActive: (video: KnowledgeVideoRow) => void;
  onDelete: (video: KnowledgeVideoRow) => void;
  folders?: KnowledgeFolderRow[];
  onMoveToFolder?: (video: KnowledgeVideoRow, folderId: string | null) => void;
}
...
export function getKnowledgeVideoColumns(actions: ColumnActions): ColumnDef<KnowledgeVideoRow>[] {
  return [
    {
      accessorKey: "name",
      header: ({ column }) => (
