...
interface ColumnActions {
  onView: (doc: KnowledgeDocumentRow) => void;
  onDownload: (doc: KnowledgeDocumentRow) => void;
  onToggleActive: (doc: KnowledgeDocumentRow) => void;
  onDelete: (doc: KnowledgeDocumentRow) => void;
  folders?: KnowledgeFolderRow[];
  onMoveToFolder?: (doc: KnowledgeDocumentRow, folderId: string | null) => void;
}
...
export function getKnowledgeDocumentColumns(actions: ColumnActions): ColumnDef<KnowledgeDocumentRow>[] {
  return [
    {
      accessorKey: "name",
      header: ({ column }) => (
