...
/**
 * Knowledge route surface for AUDIO listing.
 *
 * Coexists with src/components/audios/audios-list-client.tsx (Blocks
 ...
 * - audios-list-client.tsx: BlockListPage shell (unified chrome).
 *
