...
export const messages = {
  ...
  "financials.builder.leadership_commission.no_qualifications": "Sem qualificações — este nível não gera comissão até você adicionar uma.",
  ...
  "financials.builder.leadership_commission.qual_mix_tooltip": "Proporção de gestores nesta qualificação — pondera a taxa efetiva do nível (média ponderada das qualificações).",
