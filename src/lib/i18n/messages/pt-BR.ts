...
export const messages = {
  ...
  "financials.share.button": "Compartilhar",
  "financials.share.dialog_title": "Compartilhar esta projeção",
  "financials.share.dialog_description": "Qualquer pessoa com este link pode ver esta projeção em tela cheia — suas premissas ficam privadas.",
  "financials.share.generating": "Gerando link…",
  "financials.share.copy": "Copiar",
  "financials.share.copied": "Copiado",
  "financials.share.view_label": "Visão",
  "financials.share.sections_label": "Seções",
  "financials.share.generate": "Gerar link",
  "financials.share.active_links": "Links ativos",
  "financials.share.no_links": "Nenhum link ainda. Escolha uma visão e seções e gere um.",
  "financials.share.all_sections": "Todas as seções",
  "financials.share.revoke": "Revogar link",
  "financials.share.public_note": "Este link é público — qualquer pessoa que o tiver pode abrir a projeção.",
  "financials.share.viewing_as": "Visualizando como {role}",
  "financials.share.full_projection": "Projeção completa",
  "financials.share.untitled": "Projeção sem título",
  "financials.share.loading": "Carregando projeção…",
  "financials.share.error_title": "Projeção indisponível",
  "financials.share.error_not_found": "Esta projeção compartilhada não está disponível — o link pode ter sido revogado.",
  "financials.share.error_expired": "Este link compartilhado expirou.",
  "financials.share.error_generic": "Não foi possível carregar esta projeção. Tente novamente.",
