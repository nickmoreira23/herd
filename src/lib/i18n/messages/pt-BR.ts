...
export const messages = {
  ...
  "financials.builder.leadership_commission.tooltip": "Hierarquia de níveis de liderança (ex.: local, regional, VP). Cada nível ganha uma sobretaxa % sobre a produção mensal, ponderada pelo mix de tier (bronze/prata). Um nível ativa quando os reps ativos cruzam seu span acumulado. Custo 0 quando desabilitado. Roteie compartilhado vs. parte no card \"Atribuição de Custos\".",
  ...
  "financials.builder.leadership_commission.order_hint": "Níveis ordenados da base (mais perto dos reps) ao topo. Cada nível ativa quando os reps ativos cruzam o span acumulado.",
  ...
  "financials.builder.leadership_commission.level_bronze_rate_label": "Taxa bronze %",
  "financials.builder.leadership_commission.level_bronze_rate_tooltip": "Sobretaxa % dos gestores tier bronze deste nível sobre a produção.",
  "financials.builder.leadership_commission.level_prata_rate_label": "Taxa prata %",
  "financials.builder.leadership_commission.level_prata_rate_tooltip": "Sobretaxa % dos gestores tier prata deste nível sobre a produção.",
  "financials.builder.leadership_commission.level_bronze_mix_label": "Mix bronze",
  "financials.builder.leadership_commission.level_bronze_mix_tooltip": "Peso relativo de gestores bronze neste nível. Pondera a taxa efetiva (a contagem absoluta não importa — só a proporção bronze:prata).",
  "financials.builder.leadership_commission.level_prata_mix_label": "Mix prata",
  "financials.builder.leadership_commission.level_prata_mix_tooltip": "Peso relativo de gestores prata neste nível. Pondera a taxa efetiva junto com o mix bronze.",
