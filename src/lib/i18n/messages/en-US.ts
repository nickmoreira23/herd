...
export const messages: Record<MessageKey, string> = {
  ...
  "financials.projection.section.member_earnings": "Per-member earnings",
  ...
  "financials.toolbar.perspective.parties_group": "Profit split",
  "financials.toolbar.perspective.members_group": "Sales team",
