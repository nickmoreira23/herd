...
export const messages: Record<MessageKey, string> = {
  ...
  "nav.sidebar.learn": "Learn",
  "nav.sidebar.explore": "Explore",
  "nav.sidebar.exercise": "Exercise",
  "nav.sidebar.nutrition": "Nutrition",
  "nav.sidebar.hydration": "Hydration",
  "nav.sidebar.sleep": "Sleep",
  "nav.sidebar.recovery": "Recovery",
  "nav.sidebar.notifications": "Notifications",
  "nav.sidebar.memories": "Memories",
  "nav.sidebar.help_center": "Help Center",
  "nav.sidebar.organize": "Organize",
  ...
  "commissions.simulator.input.billing_tooltip":
    "How subscribers pay. Biannual/annual plans are discounted, so this mix affects average revenue per subscriber and residual calculations.",
  "commissions.simulator.input.billing_monthly": "Monthly %",
  "commissions.simulator.input.billing_biannual": "Biannual %",
  ...
  "financials.cascade.level_unnamed": "Unnamed level",
  ...
  "financials.projection.tier_subindent_with_count": "      └ {tier} ({count} subs)",
  ...
  "financials.member_earnings.rep_tooltip": "One rep selling at the scenario's sales-per-rep rate from month 1. Upfront commission on each sale plus residual on their still-active book.",
  ...
  "financials.share.button": "Share",
  "financials.share.dialog_title": "Share this projection",
  "financials.share.dialog_description": "Anyone with this link can view this projection full-screen — your assumptions stay private.",
  "financials.share.generating": "Generating link…",
  "financials.share.copy": "Copy",
  "financials.share.copied": "Copied",
  "financials.share.view_label": "View",
  "financials.share.sections_label": "Sections",
  "financials.share.generate": "Generate link",
  "financials.share.active_links": "Active links",
  "financials.share.no_links": "No links yet. Pick a view and sections, then generate one.",
  "financials.share.all_sections": "All sections",
  "financials.share.revoke": "Revoke link",
  "financials.share.public_note": "This link is public — anyone who has it can open the projection.",
  "financials.share.viewing_as": "Viewing as {role}",
  "financials.share.full_projection": "Full projection",
  "financials.share.untitled": "Untitled projection",
  "financials.share.loading": "Loading projection…",
  "financials.share.error_title": "Projection unavailable",
  "financials.share.error_not_found": "This shared projection isn't available — the link may have been revoked.",
  "financials.share.error_expired": "This shared link has expired.",
  "financials.share.error_generic": "Couldn't load this projection. Please try again.",
  ...
  "financials.toolbar.button.exit_full_screen": "Minimize",
  ...
  "financials.toolbar.perspective.parties_group": "Parties",
  "financials.toolbar.perspective.members_group": "Roles",
  ...
  "financials.builder.attribution.rubric_leadership_commission": "Leadership commission",

  "financials.builder.leadership_commission.title": "Leadership commission",
  "financials.builder.leadership_commission.description": "Stacked leadership overrides on channel production",
  "financials.builder.leadership_commission.tooltip": "Leadership pyramid (e.g. local, regional, VP) above the reps. Each level earns an override % on monthly production, weighted by the mix of its qualifications. A level activates when active reps cross its cumulative span. Cost is 0 when disabled. Route shared vs. party in the \"Cost Attribution\" card.",
  "financials.builder.leadership_commission.enabled_label": "Status",
  "financials.builder.leadership_commission.enabled_on": "Enabled",
  "financials.builder.leadership_commission.enabled_off": "Disabled",
  "financials.builder.leadership_commission.base_label": "Calculation base",
  "financials.builder.leadership_commission.base_revenue": "Revenue",
  "financials.builder.leadership_commission.base_margin": "Gross Margin",
  "financials.builder.leadership_commission.base_rep_commission": "Rep Commission",
  "financials.builder.leadership_commission.order_hint": "Commission pyramid: the reps are the base; each level sits above them and turns on when the sales force crosses its cumulative span.",
  "financials.builder.leadership_commission.level_name_label": "Level {n}",
  "financials.builder.leadership_commission.level_name_placeholder": "E.g. Local, Regional, VP",
  "financials.builder.leadership_commission.reps_base_label": "Sales reps (base)",
  "financials.builder.leadership_commission.reps_base_hint": "{n} reps at the base · every level sits above them",
  "financials.builder.leadership_commission.level_activates_at": "Activates at ≥ {n} active reps",
  "financials.builder.leadership_commission.qualifications_label": "Qualifications",
  "financials.builder.leadership_commission.no_qualifications": "No qualifications — 100% of this level earns the base rate above. Add one to split the mix across qualifications.",
  "financials.builder.leadership_commission.qual_name_label": "Qualification",
  "financials.builder.leadership_commission.qual_name_placeholder": "E.g. Bronze, Prata, Gold",
  "financials.builder.leadership_commission.qual_rate_label": "Rate %",
  "financials.builder.leadership_commission.qual_rate_tooltip": "Override % this qualification earns on the level's production.",
  "financials.builder.leadership_commission.qual_mix_label": "Mix %",
  "financials.builder.leadership_commission.qual_mix_tooltip": "Share of managers at this qualification — weights the level's effective rate (mix-weighted average of base + qualifications).",
  "financials.builder.leadership_commission.add_qualification": "Add qualification",
  "financials.builder.leadership_commission.base_tier_label": "Base",
  "financials.builder.leadership_commission.base_tier_hint": "No qualification (level default)",
  "financials.builder.leadership_commission.base_rate_label": "Base rate %",
  "financials.builder.leadership_commission.base_rate_tooltip": "The level's override rate for people with no qualification. Every level has a base rate — with no qualifications, 100% of people earn it.",
  ...
  "financials.builder.leadership_commission.role_label": "Role",
  "financials.builder.leadership_commission.role_tooltip": "The name of this leadership level (e.g. Local Manager, Regional Manager, VP).",
  "financials.builder.leadership_commission.level_span_label": "Span",
  "financials.builder.leadership_commission.span_help_base": "Reps / unit",
  "financials.builder.leadership_commission.span_help_nested": "{unit} / unit",
  ...
  "financials.builder.plans.field_biannual_pct": "Biannual %",
  "financials.builder.plans.field_biannual_pct_tooltip":
    "Default % of subscribers paying every 6 months (biannually).",
  ...
  "financials.builder.plans.price_per_quarter": "{amount}/6mo",
  ...
  "financials.builder.overrides.field_qtr": "Bi %",
  "financials.builder.overrides.field_qtr_tooltip":
    "Percentage of this plan's subscribers paying biannually.",
  ...
  "organization.subpanel.access_category": "Access",
  "organization.subpanel.permissions": "Permissions",
  "organization.subpanel.roles": "Roles",
  "organization.roles.title": "Custom roles",
  "organization.roles.description":
    "Create named roles for your organization and assign them to members. Roles add to a member's system role — they never replace it.",
  "organization.roles.create_button": "New role",
  "organization.roles.loading": "Loading roles…",
  "organization.roles.empty_title": "No custom roles yet",
  "organization.roles.empty_description":
    "Custom roles let you name a group of people in your organization. Grants are added to a role once it exists.",
  "organization.roles.col_name": "Role",
  "organization.roles.col_permissions": "Permissions",
  "organization.roles.col_members": "Members",
  "organization.roles.col_actions": "Actions",
  "organization.roles.no_permissions": "No permissions yet",
  "organization.roles.permission_count": "{count} permissions",
  "organization.roles.member_count": "{count} members",
  "organization.roles.edit_action": "Edit role",
  "organization.roles.delete_action": "Delete role",
  "organization.roles.form.create_title": "New role",
  "organization.roles.form.edit_title": "Edit role",
  "organization.roles.form.create_description": "Name a custom role for your organization.",
  "organization.roles.form.edit_description": "Update this role's name, key, or description.",
  "organization.roles.form.name_label": "Name",
  "organization.roles.form.name_placeholder": "e.g. Regional Manager",
  "organization.roles.form.key_label": "Key",
  "organization.roles.form.key_placeholder": "e.g. regional-manager",
  "organization.roles.form.key_hint": "Lowercase, kebab-case identifier. Used internally.",
  "organization.roles.form.description_label": "Description",
  "organization.roles.form.description_placeholder": "What is this role for? (optional)",
  "organization.roles.form.save_create": "Create role",
  "organization.roles.form.save_edit": "Save changes",
  "organization.roles.form.saving": "Saving…",
  "organization.roles.error.reserved": "This name or key is reserved for a system role.",
  "organization.roles.error.duplicate": "A role with this key already exists.",
  "organization.roles.error.invalid": "Enter a valid name and kebab-case key.",
  "organization.roles.delete.title": "Delete role?",
  "organization.roles.delete.description":
    "Deleting “{name}” removes it from {count} member(s). This can't be undone.",
  "organization.roles.delete.confirm": "Delete role",
  "organization.roles.delete.cancel": "Cancel",
  "organization.roles.feedback.created": "Role created",
  "organization.roles.feedback.updated": "Role updated",
  "organization.roles.feedback.deleted": "Role deleted",
  ...
  "organization.permissions.role.DEPARTMENT_HEAD": "Department Head",
  "organization.permissions.role.DEPARTMENT_MANAGER": "Department Manager",
  "organization.permissions.role.DEPARTMENT_MEMBER": "Department Member",
  "organization.permissions.resource.org": "Organization",
  "organization.permissions.resource.org_settings": "Settings",
  "organization.permissions.resource.org_billing": "Billing",
  "organization.permissions.resource.org_hierarchy": "Hierarchy",
  "organization.permissions.resource.members": "Members",
  "organization.permissions.resource.departments": "Departments",
  "organization.permissions.resource.locations": "Locations",
  "organization.permissions.resource.audit_log": "Audit Log",
  "organization.permissions.resource.integrations": "Integrations",
  "organization.permissions.resource.blocks_schema": "Blocks Schema",
  "organization.permissions.resource.blocks_data": "Blocks Data",
  "organization.permissions.action.read": "Read",
  "organization.permissions.action.create": "Create",
  "organization.permissions.action.update": "Update",
  "organization.permissions.action.delete": "Delete",
  "organization.permissions.action.invite": "Invite",
  ...
  "organization.locations.search_placeholder": "Search by name, city, state…",
  "organization.locations.filter_all_types": "All types",
  "organization.locations.not_found": "No locations found",
  "organization.locations.not_found_hint": "Add the first one with \"Add Location\".",
  "organization.locations.delete_confirm": "Delete \"{name}\"?",
  "organization.locations.saved_at": "Saved {time}",
  "organization.locations.field.is_active": "Active",
  "organization.locations.field.is_headquarters_label": "Primary headquarters",
  "organization.locations.section.identification": "Identification",
  "organization.locations.section.address": "Address",
  "organization.locations.section.contact": "Contact",
  "organization.locations.section.notes": "Notes",
  "organization.locations.hq_hint": "Only one location can be the headquarters.",
  "organization.locations.active_in_use": "In use",
  "organization.locations.archived": "Archived",
  ...
  // ═══════════════════════════════════════════════════════════════════
  "knowledge.media.statuses.pending.label": "Pending",
  "knowledge.media.statuses.processing.label": "Processing",
  "knowledge.media.statuses.ready.label": "Ready",
  "knowledge.media.statuses.error.label": "Error",

  // ─── Documents: list page ──────────────────────────────────────────
  "documents.list.title": "Documents",
  "documents.list.description":
    "Guides, policies, SOPs, and reference materials for your team and partners.",
  "documents.list.upload_button": "Upload Document",
  "documents.list.new_folder_button": "New Folder",
  "documents.list.search_placeholder": "Search by name, description, or file...",
  "documents.list.items_count": "{count} item(s)",
  "documents.list.filter_all_types": "All Types",
  "documents.list.filter_all_status": "All Status",
  "documents.list.breadcrumb_root": "All Documents",
  "documents.list.folder_count_docs": "{count} doc(s)",
  "documents.list.folder_count_subfolders": "{count} folder(s)",
  "documents.columns.name": "Name",
  "documents.columns.type": "Type",
  "documents.columns.size": "Size",
  "documents.columns.status": "Status",
  "documents.columns.uploaded": "Uploaded",
  "documents.columns.actions.view": "View",
  "documents.columns.actions.download": "Download",
  "documents.columns.actions.move_to_folder": "Move to folder",
  "documents.columns.actions.move_to_root": "Root (no folder)",
  "documents.columns.actions.activate": "Activate",
  "documents.columns.actions.deactivate": "Deactivate",
  "documents.columns.actions.delete": "Delete",
  "documents.empty.title": "No documents yet",
  "documents.empty.description":
    "Upload guides, policies, SOPs, and other reference materials. Documents will be available to your team and can be shared with partners.",
  "documents.empty.upload_first": "Upload your first document",
  "documents.upload.title": "Upload Document",
  "documents.upload.drop_here": "Drop a file here or click to browse",
  "documents.upload.accepted_formats": "PDF, DOCX, TXT, MD, or CSV",
  "documents.upload.field_name": "Name",
  "documents.upload.field_name_placeholder": "Document name",
  "documents.upload.field_description": "Description (optional)",
  "documents.upload.field_description_placeholder": "What is this document about?",
  "documents.upload.button_idle": "Upload Document",
  "documents.upload.button_uploading": "Uploading...",
  "documents.viewer.title": "Document Viewer",
  "documents.viewer.field_name": "Name",
  "documents.viewer.field_description": "Description",
  "documents.viewer.field_description_placeholder": "Add a description...",
  "documents.viewer.action_download": "Download",
  "documents.viewer.action_save": "Save",
  "documents.viewer.action_process": "Process",
  "documents.viewer.action_reprocess": "Re-process",
  "documents.viewer.uploaded_at": "Uploaded {date}",
  "documents.viewer.chunks_count": "{count} chunk(s)",
  "documents.viewer.tab_preview": "Preview",
  "documents.viewer.tab_text": "Extracted Text",
  "documents.viewer.state_pending":
    "Document has not been processed yet. Click “Process” to extract text.",
  "documents.viewer.state_processing": "Processing document...",
  "documents.viewer.state_error":
    "Processing failed. Click “Re-process” to try again.",
  "documents.viewer.no_text": "No text content extracted.",
  "documents.feedback.uploaded": "Document uploaded. Processing started...",
  "documents.feedback.updated": "Document updated",
  "documents.feedback.deleted": "Document deleted",
  "documents.feedback.activated": "Activated",
  "documents.feedback.deactivated": "Deactivated",
  "documents.feedback.processing_started": "Processing started",
  "documents.feedback.moved_to_folder": "Moved to folder",
  "documents.feedback.moved_to_root": "Moved to root",
  "documents.feedback.folder_deleted": "Folder deleted",
  "error.documents.select_file": "Select a file",
  "error.documents.name_required": "Name is required",
  "error.documents.upload_failed": "File upload failed",
  "error.documents.save_failed": "Failed to save document",
  "error.documents.update_failed": "Failed to update",
  "error.documents.delete_failed": "Failed to delete document",
  "error.documents.processing_failed": "Processing failed",
  "error.documents.folder_delete_failed": "Failed to delete folder",

  // ─── Images: list page ─────────────────────────────────────────────
  "images.list.title": "Images",
  "images.list.description":
    "Photos, screenshots, diagrams, and visual assets for your knowledge base.",
  "images.list.upload_button": "Upload Image",
  "images.list.new_folder_button": "New Folder",
  "images.list.search_placeholder": "Search by name, description, or file...",
  "images.list.items_count": "{count} item(s)",
  "images.list.filter_all_types": "All Types",
  "images.list.filter_all_status": "All Status",
  "images.list.breadcrumb_root": "All Images",
  "images.list.folder_count_images": "{count} image(s)",
  "images.list.folder_count_subfolders": "{count} folder(s)",
  "images.columns.name": "Name",
  "images.columns.type": "Type",
  "images.columns.dimensions": "Dimensions",
  "images.columns.size": "Size",
  "images.columns.status": "Status",
  "images.columns.uploaded": "Uploaded",
  "images.columns.actions.view": "View",
  "images.columns.actions.download": "Download",
  "images.columns.actions.move_to_folder": "Move to folder",
  "images.columns.actions.move_to_root": "Root (no folder)",
  "images.columns.actions.activate": "Activate",
  "images.columns.actions.deactivate": "Deactivate",
  "images.columns.actions.delete": "Delete",
  "images.empty.title": "No images yet",
  "images.empty.description":
    "Upload photos, screenshots, diagrams, and other visual assets. Images will be analyzed by AI to generate searchable text descriptions.",
  "images.empty.upload_first": "Upload your first image",
  "images.upload.title": "Upload Image",
  "images.upload.drop_here": "Drop an image here or click to browse",
  "images.upload.accepted_formats": "PNG, JPG, WEBP, GIF, SVG, or TIFF",
  "images.upload.field_name": "Name",
  "images.upload.field_name_placeholder": "Image name",
  "images.upload.field_description": "Description (optional)",
  "images.upload.field_description_placeholder": "What is this image about?",
  "images.upload.button_idle": "Upload Image",
  "images.upload.button_uploading": "Uploading...",
  "images.viewer.title": "Image Viewer",
  "images.viewer.field_name": "Name",
  "images.viewer.field_description": "Description",
  "images.viewer.field_description_placeholder": "Add a description...",
  "images.viewer.action_download": "Download",
  "images.viewer.action_save": "Save",
  "images.viewer.action_process": "Process",
  "images.viewer.action_reprocess": "Re-process",
  "images.viewer.uploaded_at": "Uploaded {date}",
  "images.viewer.chunks_count": "{count} chunk(s)",
  "images.viewer.tab_preview": "Preview",
  "images.viewer.tab_description": "AI Description",
  "images.viewer.state_pending":
    "Image has not been processed yet. Click “Process” to generate a description.",
  "images.viewer.state_processing": "Processing image...",
  "images.viewer.state_error":
    "Processing failed. Click “Re-process” to try again.",
  "images.viewer.no_description": "No AI description generated yet.",
  "images.feedback.uploaded": "Image uploaded. Processing started...",
  "images.feedback.updated": "Image updated",
  "images.feedback.deleted": "Image deleted",
  "images.feedback.activated": "Activated",
  "images.feedback.deactivated": "Deactivated",
  "images.feedback.processing_started": "Processing started",
  "images.feedback.moved_to_folder": "Moved to folder",
  "images.feedback.moved_to_root": "Moved to root",
  "images.feedback.folder_deleted": "Folder deleted",
  "error.images.select_file": "Select a file",
  "error.images.name_required": "Name is required",
  "error.images.upload_failed": "File upload failed",
  "error.images.save_failed": "Failed to save image",
  "error.images.update_failed": "Failed to update",
  "error.images.delete_failed": "Failed to delete image",
  "error.images.processing_failed": "Processing failed",
  "error.images.folder_delete_failed": "Failed to delete folder",

  // ─── Videos: list page ─────────────────────────────────────────────
  "videos.list.title": "Videos",
  "videos.list.description":
    "Video content transcribed with AI-powered speaker diarization for your knowledge base.",
  "videos.list.upload_button": "Upload Video",
  "videos.list.new_folder_button": "New Folder",
  "videos.list.search_placeholder": "Search by name, description, or file...",
  "videos.list.items_count": "{count} item(s)",
  "videos.list.filter_all_types": "All Types",
  "videos.list.filter_all_status": "All Status",
  "videos.list.breadcrumb_root": "All Videos",
  "videos.list.folder_count_videos": "{count} video(s)",
  "videos.list.folder_count_subfolders": "{count} folder(s)",
  "videos.columns.name": "Name",
  "videos.columns.type": "Type",
  "videos.columns.duration": "Duration",
  "videos.columns.size": "Size",
  "videos.columns.status": "Status",
  "videos.columns.uploaded": "Uploaded",
  "videos.columns.actions.view": "View",
  "videos.columns.actions.download": "Download",
  "videos.columns.actions.move_to_folder": "Move to folder",
  "videos.columns.actions.move_to_root": "Root (no folder)",
  "videos.columns.actions.activate": "Activate",
  "videos.columns.actions.deactivate": "Deactivate",
  "videos.columns.actions.delete": "Delete",
  ...
  "videos.empty.upload_first": "Upload your first video",
  "videos.upload.title": "Upload Video",
  "videos.upload.drop_here": "Drop a file here or click to browse",
  "videos.upload.accepted_formats": "MP4, MOV, WEBM, or AVI",
  "videos.upload.transcription_note":
    "Videos will be transcribed with speaker diarization",
  "videos.upload.field_name": "Name",
  "videos.upload.field_name_placeholder": "Video name",
  "videos.upload.field_description": "Description (optional)",
  "videos.upload.field_description_placeholder": "What is this video about?",
  "videos.upload.button_idle": "Upload Video",
  "videos.upload.button_uploading": "Uploading...",
  "videos.viewer.title": "Video Viewer",
  "videos.viewer.field_name": "Name",
  "videos.viewer.field_description": "Description",
  "videos.viewer.field_description_placeholder": "Add a description...",
  "videos.viewer.action_download": "Download",
  "videos.viewer.action_save": "Save",
  "videos.viewer.action_transcribe": "Transcribe",
  "videos.viewer.action_retranscribe": "Re-transcribe",
  "videos.viewer.uploaded_at": "Uploaded {date}",
  "videos.viewer.chunks_count": "{count} chunk(s)",
  "videos.viewer.tab_preview": "Preview",
  "videos.viewer.tab_transcript": "Transcript",
  "videos.viewer.state_pending":
    "Video has not been transcribed yet. Click “Transcribe” to start.",
  "videos.viewer.state_processing": "Transcribing video...",
  "videos.viewer.state_error":
    "Transcription failed. Click “Re-transcribe” to try again.",
  "videos.viewer.no_transcript": "No transcript available.",
  "videos.feedback.uploaded": "Video uploaded. Transcription started...",
  "videos.feedback.updated": "Video updated",
  "videos.feedback.deleted": "Video deleted",
  "videos.feedback.activated": "Activated",
  "videos.feedback.deactivated": "Deactivated",
  "videos.feedback.transcription_started": "Transcription started",
  "videos.feedback.moved_to_folder": "Moved to folder",
  "videos.feedback.moved_to_root": "Moved to root",
  "videos.feedback.folder_deleted": "Folder deleted",
  "error.videos.select_file": "Select a file",
  "error.videos.name_required": "Name is required",
  "error.videos.upload_failed": "File upload failed",
  "error.videos.save_failed": "Failed to save video",
  "error.videos.update_failed": "Failed to update",
  "error.videos.delete_failed": "Failed to delete video",
  "error.videos.transcription_failed": "Transcription failed",
  "error.videos.folder_delete_failed": "Failed to delete folder",

  // ─── Audios: list page ─────────────────────────────────────────────
  "audios.list.title": "Audios",
  "audios.list.description":
    "Audio content transcribed with AI-powered speaker diarization for your knowledge base.",
  "audios.list.upload_button": "Upload Audio",
  "audios.list.new_folder_button": "New Folder",
  "audios.list.search_placeholder": "Search by name, description, or file...",
  "audios.list.items_count": "{count} item(s)",
  "audios.list.filter_all_types": "All Types",
  "audios.list.filter_all_status": "All Status",
  "audios.list.breadcrumb_root": "All Audios",
  "audios.list.folder_count_audios": "{count} audio(s)",
  "audios.list.folder_count_subfolders": "{count} folder(s)",
  "audios.columns.name": "Name",
  "audios.columns.type": "Type",
  "audios.columns.duration": "Duration",
  "audios.columns.size": "Size",
  "audios.columns.status": "Status",
  "audios.columns.uploaded": "Uploaded",
  "audios.columns.actions.view": "View",
  "audios.columns.actions.download": "Download",
  "audios.columns.actions.move_to_folder": "Move to folder",
  "audios.columns.actions.move_to_root": "Root (no folder)",
  "audios.columns.actions.activate": "Activate",
  "audios.columns.actions.deactivate": "Deactivate",
  "audios.columns.actions.delete": "Delete",
  "audios.empty.title": "No audios yet",
  "audios.empty.description":
    "Upload audio content to be automatically transcribed with speaker diarization. Transcripts become searchable knowledge for your AI agents.",
  "audios.empty.upload_first": "Upload your first audio",
  "audios.upload.title": "Upload Audio",
  "audios.upload.drop_here": "Drop an audio file here or click to browse",
  "audios.upload.accepted_formats": "MP3, WAV, OGG, FLAC, AAC, or M4A",
  "audios.upload.transcription_note":
    "Audio will be transcribed with speaker diarization",
  "audios.upload.field_name": "Name",
  "audios.upload.field_name_placeholder": "Audio name",
  "audios.upload.field_description": "Description (optional)",
  "audios.upload.field_description_placeholder": "What is this audio about?",
  "audios.upload.button_idle": "Upload Audio",
  "audios.upload.button_uploading": "Uploading...",
  "audios.viewer.title": "Audio Viewer",
  "audios.viewer.field_name": "Name",
  "audios.viewer.field_description": "Description",
  "audios.viewer.field_description_placeholder": "Add a description...",
  "audios.viewer.action_download": "Download",
  "audios.viewer.action_save": "Save",
  "audios.viewer.action_transcribe": "Transcribe",
  "audios.viewer.action_retranscribe": "Re-transcribe",
  "audios.viewer.uploaded_at": "Uploaded {date}",
  "audios.viewer.chunks_count": "{count} chunk(s)",
  "audios.viewer.tab_player": "Player",
  "audios.viewer.tab_transcript": "Transcript",
  "audios.viewer.state_pending":
    "Audio has not been transcribed yet. Click “Transcribe” to start.",
  "audios.viewer.state_processing": "Transcribing audio...",
  "audios.viewer.state_error":
    "Transcription failed. Click “Re-transcribe” to try again.",
  "audios.viewer.no_transcript": "No transcript available.",
  "audios.feedback.uploaded": "Audio uploaded. Transcription started...",
  "audios.feedback.updated": "Audio updated",
  "audios.feedback.deleted": "Audio deleted",
  "audios.feedback.activated": "Activated",
  "audios.feedback.deactivated": "Deactivated",
  "audios.feedback.transcription_started": "Transcription started",
  "audios.feedback.moved_to_folder": "Moved to folder",
  "audios.feedback.moved_to_root": "Moved to root",
  "audios.feedback.folder_deleted": "Folder deleted",
  "error.audios.select_file": "Select a file",
  "error.audios.name_required": "Name is required",
  "error.audios.upload_failed": "File upload failed",
  "error.audios.save_failed": "Failed to save audio",
  "error.audios.update_failed": "Failed to update",
  ...
  // Meeting Prep — tool that helps users prepare for important meetings
  // through context briefing, expert panel, prep plan, role-play, and debrief.
  "meeting_prep.tool.name": "Meeting Prep",
  "meeting_prep.tool.short_description":
    "Prep for important meetings with multi-agent role-play.",
  "meeting_prep.tool.description":
    "Capture meeting context, activate a panel of experts, build a strategic prep plan, rehearse via role-play, and walk in with a checklist.",
  "meeting_prep.tool.beta_badge": "Beta",

  "meeting_prep.list.title": "Meeting Prep",
  "meeting_prep.list.description":
    "Sessions you've prepared. Each session captures the briefing, the expert panel, the plan, role-play and debrief.",
  "meeting_prep.list.new_session": "New session",
  "meeting_prep.list.empty_title": "No sessions yet",
  "meeting_prep.list.empty_body":
    "Start a new session to capture the context of an upcoming meeting.",
  "meeting_prep.list.column.title": "Title",
  "meeting_prep.list.column.type": "Type",
  "meeting_prep.list.column.status": "Status",
  "meeting_prep.list.column.updated": "Updated",
  "meeting_prep.list.column.actions": "",
  "meeting_prep.list.untitled": "Untitled session",
  "meeting_prep.list.delete": "Delete",
  "meeting_prep.list.delete_confirm":
    "Delete this session? This cannot be undone.",

  "meeting_prep.status.draft": "Draft",
  "meeting_prep.status.briefed": "Briefed",
  "meeting_prep.status.specialists_ready": "Specialists ready",
  "meeting_prep.status.plan_ready": "Plan ready",
  "meeting_prep.status.rehearsed": "Rehearsed",
  "meeting_prep.status.closed": "Closed",

  "meeting_prep.briefing.crumb": "Tools",
  "meeting_prep.briefing.title": "Meeting briefing",
  "meeting_prep.briefing.description":
    "Describe the meeting context. Smart defaults — everything is editable. Auto-saves as you type.",
  "meeting_prep.briefing.progress": "{filled} of {total} sections",
  "meeting_prep.briefing.autosave_idle": "All changes saved",
  "meeting_prep.briefing.autosave_pending": "Saving…",
  "meeting_prep.briefing.optional": "Optional",
  "meeting_prep.briefing.recommended": "Recommended",

  // Sections
  "meeting_prep.briefing.section.identification": "1. Identification",
  "meeting_prep.briefing.section.identification_help":
    "What this meeting is and when it happens.",
  "meeting_prep.briefing.section.objective": "2. Business objective",
  "meeting_prep.briefing.section.objective_help":
    "What you're trying to accomplish — concrete and measurable.",
  "meeting_prep.briefing.section.participants": "3. Participants",
  "meeting_prep.briefing.section.participants_help":
    "Who else is in the room. At least one.",
  "meeting_prep.briefing.section.outcome": "4. Desired outcome",
  "meeting_prep.briefing.section.outcome_help":
    "What success looks like — and the minimum acceptable result.",
  "meeting_prep.briefing.section.context": "5. Additional context",
  "meeting_prep.briefing.section.context_help":
    "History, constraints, and tone — sharpens every other step.",

  // Identification fields
  "meeting_prep.field.title": "Meeting title",
  "meeting_prep.field.title_placeholder":
    "e.g. Q1 board review · Acme negotiation · Sarah 1:1",
  "meeting_prep.field.meeting_type": "Type",
  "meeting_prep.field.meeting_type_placeholder": "Choose a type",
  "meeting_prep.field.scheduled_at": "Scheduled at",
  "meeting_prep.field.duration": "Estimated duration",
  "meeting_prep.field.duration_value": "{minutes} min",

  "meeting_prep.meeting_type.one_on_one": "1:1",
  "meeting_prep.meeting_type.commercial": "Commercial / Sales",
  "meeting_prep.meeting_type.board": "Board / Directors",
  "meeting_prep.meeting_type.hr_feedback": "HR / Feedback / Performance",
  "meeting_prep.meeting_type.negotiation": "Negotiation",
  "meeting_prep.meeting_type.interview": "Interview",
  "meeting_prep.meeting_type.kickoff": "Kickoff",
  "meeting_prep.meeting_type.partnership": "Partnership",
  "meeting_prep.meeting_type.investor": "Investor",
  "meeting_prep.meeting_type.other": "Other",

  // Objective
  "meeting_prep.field.objective": "Objective",
  "meeting_prep.field.objective_placeholder.one_on_one":
    "e.g. Unblock the Acme deliverable and align next-week priorities.",
  "meeting_prep.field.objective_placeholder.commercial":
    "e.g. Move the Acme deal to proposal stage with explicit commitment.",
  "meeting_prep.field.objective_placeholder.board":
    "e.g. Get approval for the Q1 plan and the marketing budget delta.",
  "meeting_prep.field.objective_placeholder.hr_feedback":
    "e.g. Deliver structured feedback and agree on a 30-day plan.",
  "meeting_prep.field.objective_placeholder.negotiation":
    "e.g. Reach an agreement that respects my BATNA and creates mutual gain.",
  "meeting_prep.field.objective_placeholder.interview":
    "e.g. Decide whether the candidate matches the senior role's bar.",
  "meeting_prep.field.objective_placeholder.kickoff":
    "e.g. Set scope, deadlines, and roles with no gray areas.",
  "meeting_prep.field.objective_placeholder.partnership":
    "e.g. Identify if interests align enough to start a pilot.",
  "meeting_prep.field.objective_placeholder.investor":
    "e.g. Generate enough interest to schedule a follow-up with the decider.",
  "meeting_prep.field.objective_placeholder.other":
    "e.g. Walk out with a clear written decision.",
  "meeting_prep.field.objective_placeholder.default":
    "Describe what you want to accomplish in one or two sentences.",
  "meeting_prep.field.suggest_objectives": "Suggest 3 objectives",
  "meeting_prep.field.suggest_objectives_loading": "Generating ideas…",
  "meeting_prep.field.suggest_objectives_use": "Use this",
  "meeting_prep.field.suggest_objectives_dismiss": "Dismiss suggestions",

  // Participants
  "meeting_prep.participants.add": "Add participant",
  "meeting_prep.participants.remove": "Remove",
  "meeting_prep.participants.empty":
    "No participants yet — add at least one.",
  "meeting_prep.participant.name": "Name",
  "meeting_prep.participant.name_placeholder": "e.g. Sarah Lin",
  "meeting_prep.participant.role": "Role",
  "meeting_prep.participant.role_placeholder": "e.g. VP of Sales",
  "meeting_prep.participant.organization": "Organization",
  "meeting_prep.participant.organization_placeholder": "e.g. Acme Corp",
  "meeting_prep.participant.relationship": "Relationship",
  "meeting_prep.participant.profile_notes": "Profile notes",
  "meeting_prep.participant.profile_notes_placeholder":
    "What you've observed — communication style, hot buttons, history.",

  "meeting_prep.relationship.subordinate": "Subordinate",
  "meeting_prep.relationship.peer": "Peer",
  "meeting_prep.relationship.superior": "Superior",
  "meeting_prep.relationship.client": "Client",
  "meeting_prep.relationship.supplier": "Supplier",
  "meeting_prep.relationship.partner": "Partner",
  "meeting_prep.relationship.unknown": "Unknown",

  // Outcome
  "meeting_prep.field.desired_outcome":
    "If this meeting is a success, what does that look like?",
  "meeting_prep.field.desired_outcome_placeholder":
    "Describe a concrete success state — what's true at the end that wasn't true at the start.",
  "meeting_prep.field.batna":
    "Minimum acceptable result (BATNA)",
  "meeting_prep.field.batna_placeholder":
    "What's your fallback if you can't reach the ideal outcome?",

  // Additional context
  "meeting_prep.field.history":
    "Relevant history",
  "meeting_prep.field.history_placeholder":
    "What happened before that matters for this meeting?",
  "meeting_prep.field.constraints": "Constraints",
  "meeting_prep.field.constraints_placeholder":
    "e.g. confidentiality, internal policy, deadline, budget.",
  "meeting_prep.field.tone_tags": "Desired tone",
  "meeting_prep.tone.formal": "Formal",
  "meeting_prep.tone.consultive": "Consultive",
  "meeting_prep.tone.assertive": "Assertive",
  "meeting_prep.tone.collaborative": "Collaborative",
  "meeting_prep.tone.empathetic": "Empathetic",
  "meeting_prep.tone.direct": "Direct",

  // Validation
  "meeting_prep.validation.title": "Before you continue",
  "meeting_prep.validation.missing_title":
    "Add a meeting title — it grounds every other step.",
  "meeting_prep.validation.missing_meeting_type":
    "Pick a meeting type so the system can tailor suggestions.",
  "meeting_prep.validation.missing_objective":
    "Describe the objective — without it the prep plan can't focus.",
  ...
  "meeting_prep.validation.suggest_batna":
    "Adding a BATNA gives the role-play teeth — you'll know when to walk.",
  "meeting_prep.validation.suggest_tone":
    "A tone choice keeps the prep plan from sounding generic.",
  "meeting_prep.validation.suggest_history":
    "Even a sentence of history sharpens persona suggestions a lot.",

  // Summary panel
  "meeting_prep.summary.title": "Consolidated brief",
  "meeting_prep.summary.placeholder":
    "After validating, your context will be summarized here. You can edit it freely.",
  "meeting_prep.summary.regenerate": "Regenerate",
  "meeting_prep.summary.regenerating": "Regenerating…",

  // Footer actions
  "meeting_prep.actions.save_draft": "Save draft",
  "meeting_prep.actions.validate_continue": "Validate and continue",
  "meeting_prep.actions.continue_anyway": "Continue anyway",
  "meeting_prep.actions.cancel": "Cancel",
  "meeting_prep.actions.back_to_list": "Back to sessions",

  // Toasts
  "meeting_prep.feedback.draft_saved": "Draft saved",
  "meeting_prep.feedback.briefed": "Brief ready — specialists unlock next.",
  "meeting_prep.feedback.session_deleted": "Session deleted",
  "error.meeting_prep.session_not_found": "Session not found",
  "error.meeting_prep.suggest_failed": "Couldn't generate suggestions — try again.",
  "error.meeting_prep.validate_failed": "Validation failed — try again.",

  // Specialists panel — feature 02
  "meeting_prep.specialists.crumb": "Specialists",
  "meeting_prep.specialists.title": "Specialist panel",
  "meeting_prep.specialists.description":
    "Activate the experts who will read your meeting through their own lens. Select 1 to 5.",
  "meeting_prep.specialists.tab.archetype": "Archetypes",
  "meeting_prep.specialists.tab.inspired": "Inspired",
  ...
  "meeting_prep.specialists.select_min":
    "Pick at least one specialist to convene.",
  "meeting_prep.specialists.select_max":
    "5 is the cap — deselect one to add another.",
  "meeting_prep.specialists.convene": "Convene panel",
  "meeting_prep.specialists.add_to_panel": "Add to panel",
  "meeting_prep.specialists.remove_from_panel": "Remove",
  "meeting_prep.specialists.next_step": "Continue to prep plan",
  "meeting_prep.specialists.streaming": "Streaming…",
  "meeting_prep.specialists.complete": "Ready",
  "meeting_prep.specialists.queued": "Queued",
  "meeting_prep.specialists.error": "Error — try regenerating.",

  "meeting_prep.specialists.section.situation": "Reading the situation",
  "meeting_prep.specialists.section.priorities": "Prioritize",
  "meeting_prep.specialists.section.avoid": "Avoid",
  "meeting_prep.specialists.section.question": "Question for you",
  "meeting_prep.specialists.section.anchor": "Anchor phrase",

  "meeting_prep.specialists.action.regenerate": "Regenerate",
  "meeting_prep.specialists.action.pin": "Pin to plan",
  "meeting_prep.specialists.action.unpin": "Unpin",
  "meeting_prep.specialists.action.remove": "Remove from panel",
  "meeting_prep.specialists.action.add_custom": "Add custom",

  "meeting_prep.specialists.custom.title": "Custom specialist",
  "meeting_prep.specialists.custom.description":
    "Describe the role in 1-2 sentences. Outputs are session-only and not saved to the library.",
  "meeting_prep.specialists.custom.placeholder":
    "e.g. A senior B2B marketing director skeptical of broad reach plays.",

  "meeting_prep.specialists.inspired.toggle":
    "Inspired personas (workspace setting)",
  "meeting_prep.specialists.inspired.toggle_help":
    "Disable to hide reasoning models inspired by public figures.",
  "meeting_prep.specialists.inspired.disabled_body":
    "This workspace has the inspired persona library disabled. An admin can re-enable it in workspace settings.",
  "meeting_prep.specialists.inspired.disclaimer":
    "AI interpretation of the public principles attributed to {name}. Not actual statements by {name}.",
  "meeting_prep.specialists.inspired.style_prefix": "Style of {name}",
  "meeting_prep.specialists.inspired.sources": "Public sources",
  "meeting_prep.specialists.inspired.principles": "Thinking principles",
  "meeting_prep.specialists.inspired.show_card": "Show details",
  "meeting_prep.specialists.inspired.hide_card": "Hide details",

  "meeting_prep.specialists.empty_panel.title":
    "No specialists yet",
  "meeting_prep.specialists.empty_panel.body":
    "Pick a few from the gallery and convene the panel.",

  "meeting_prep.feedback.specialists_ready":
    "Panel ready — review and pin what matters most for the plan.",

  // Prep plan — feature 03
  "meeting_prep.plan.crumb": "Plan",
  "meeting_prep.plan.title": "Prep plan",
  "meeting_prep.plan.description":
    "Single-screen brief to read 30 minutes before the meeting. Streamed and editable per section.",
  "meeting_prep.plan.empty.title": "No plan yet",
  "meeting_prep.plan.empty.body":
    "Generate the plan from your context and the activated specialists. Pinned ones get extra weight.",
  "meeting_prep.plan.action.generate": "Generate plan",
  "meeting_prep.plan.action.regenerate_all": "Regenerate everything",
  "meeting_prep.plan.action.regenerating": "Generating…",
  "meeting_prep.plan.action.regenerate_section": "Regenerate section",
  "meeting_prep.plan.action.edit": "Edit",
  "meeting_prep.plan.action.save": "Save",
  "meeting_prep.plan.action.cancel": "Cancel",
  "meeting_prep.plan.action.copy_md": "Copy as Markdown",
  "meeting_prep.plan.action.print": "Print / PDF",
  "meeting_prep.plan.action.continue": "Continue to role-play",

  "meeting_prep.plan.toc.title": "Sections",
  "meeting_prep.plan.stale.title": "Plan is out of date",
  "meeting_prep.plan.stale.body":
    "Context or specialist pins changed since this plan was generated. Regenerate to refresh.",
  "meeting_prep.plan.stale.dismiss": "Dismiss",
  "meeting_prep.plan.generated_at": "Generated {when}",
  "meeting_prep.plan.edited_at": "Edited {when}",

  "meeting_prep.plan.section.executive_summary": "Executive summary",
  "meeting_prep.plan.section.objectives": "The 3 objectives",
  "meeting_prep.plan.section.counterpart_motives": "What the other side likely wants",
  "meeting_prep.plan.section.risks": "Risks",
  "meeting_prep.plan.section.opportunities": "Opportunities",
  "meeting_prep.plan.section.anticipated_questions": "Questions they'll likely ask",
  "meeting_prep.plan.section.my_questions": "Questions YOU should ask",
  "meeting_prep.plan.section.objections": "Expected objections",
  "meeting_prep.plan.section.anchor_phrases": "Anchor phrases",
  "meeting_prep.plan.section.plan_b": "Plan B",
  "meeting_prep.plan.section.materials_checklist": "Materials checklist",

  "meeting_prep.plan.label.rationale": "Why",
  "meeting_prep.plan.label.mitigation": "Mitigation",
  "meeting_prep.plan.label.suggested_answer": "Suggested answer",
  "meeting_prep.plan.label.reveals": "What it reveals",
  "meeting_prep.plan.label.response": "How to respond",
  "meeting_prep.plan.label.opening": "Opening",
  "meeting_prep.plan.label.pivot": "Pivot",
  "meeting_prep.plan.label.closing": "Closing",
  "meeting_prep.plan.placeholder.text":
    "Type a paragraph. Save with the button below — auto-save on blur.",

  "meeting_prep.feedback.plan_ready":
    "Plan ready — read top to bottom before the meeting.",
  "meeting_prep.feedback.plan_section_regenerated": "Section regenerated.",
  "meeting_prep.feedback.plan_md_copied": "Markdown copied to clipboard.",
  ...
  "organization.members.invite_button": "Invite member",
  "organization.members.active_section": "Active members ({count})",
  "organization.members.col_name": "Name",
  "organization.members.col_email": "Email",
  "organization.members.col_role": "Role",
  "organization.members.col_joined": "Joined",
  "organization.members.empty_active": "No active members.",
  "organization.members.pending_section": "Pending invitations ({count})",
  "organization.members.col_expires": "Expires",
  "organization.members.col_actions": "Actions",
  "organization.members.empty_pending": "No pending invitations.",
  "organization.members.invite_dialog_title": "Invite new member",
  ...
  "organization.members.invite_field_role": "Role",
  ...
  "invitations.accept.heading": "You've been invited",
  "invitations.accept.subheading": "to",
  "invitations.accept.error_password_mismatch": "Passwords do not match",
  "invitations.accept.error_fallback": "Failed to accept invitation",
  "invitations.accept.logged_as": "Logged in as",
  "invitations.accept.accepting": "Accepting...",
  "invitations.accept.accept_button": "Accept invitation",
  "invitations.accept.login_prompt": "Log in with",
  "invitations.accept.login_prompt_suffix": "to accept this invitation.",
  "invitations.accept.login_link": "Log in",
  "invitations.accept.field_email": "Email",
  "invitations.accept.field_password": "Password",
  "invitations.accept.password_placeholder": "At least 8 characters",
  "invitations.accept.hide_password": "Hide",
  "invitations.accept.show_password": "Show",
  "invitations.accept.field_confirm_password": "Confirm password",
  ...
  "invitations.view.go_home": "Go to home",
  "invitations.view.expired_title": "Invitation expired",
  "invitations.view.expired_body":
    "This invitation has expired. Request a new invitation from the organization administrator.",
  "invitations.view.unavailable_title": "Invitation unavailable",
  "invitations.view.already_accepted": "This invitation has already been accepted.",
  "invitations.view.declined": "This invitation was declined.",
  "invitations.view.already_expired": "This invitation has expired.",
};
