...
export const messages: Record<MessageKey, string> = {
  ...
  "financials.builder.leadership_commission.no_qualifications": "No qualifications — this level earns nothing until you add one.",
  ...
  "financials.builder.leadership_commission.qual_mix_tooltip": "Share of managers at this qualification — weights the level's effective rate (mix-weighted average of the qualifications).",
