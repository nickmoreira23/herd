...
export const messages: Record<MessageKey, string> = {
  ...
  "financials.builder.leadership_commission.tooltip": "Hierarchy of leadership levels (e.g. local, regional, VP). Each level earns an override % on monthly production, weighted by its tier mix (bronze/prata). A level activates when active reps cross its cumulative span. Cost is 0 when disabled. Route shared vs. party in the \"Cost Attribution\" card.",
  ...
  "financials.builder.leadership_commission.order_hint": "Levels ordered from the base (closest to reps) up. Each activates when active reps cross the cumulative span.",
  ...
  "financials.builder.leadership_commission.level_bronze_rate_label": "Bronze rate %",
  "financials.builder.leadership_commission.level_bronze_rate_tooltip": "Override % for this level's bronze-tier managers on production.",
  "financials.builder.leadership_commission.level_prata_rate_label": "Prata rate %",
  "financials.builder.leadership_commission.level_prata_rate_tooltip": "Override % for this level's prata-tier managers on production.",
  "financials.builder.leadership_commission.level_bronze_mix_label": "Bronze mix",
  "financials.builder.leadership_commission.level_bronze_mix_tooltip": "Relative weight of bronze managers at this level. Weights the effective rate (absolute count doesn't matter — only the bronze:prata proportion).",
  "financials.builder.leadership_commission.level_prata_mix_label": "Prata mix",
  "financials.builder.leadership_commission.level_prata_mix_tooltip": "Relative weight of prata managers at this level. Weights the effective rate alongside the bronze mix.",
