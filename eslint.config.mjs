...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    "build/**",
    "next-env.d.ts",
    // Claude Code parallel-session worktrees — ephemeral local checkouts,
    // not part of this branch's code.
    ".claude/worktrees/**",
  ]),
...

  {
    files: [
      ...
      // Phase 1.5.6d-γ — Apps Admin (full)
      "src/components/apps/**/*.{ts,tsx}",
      "src/components/knowledge/apps/**/*.{ts,tsx}",
